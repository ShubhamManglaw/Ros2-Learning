...
{
  new (message_memory) my_robot_interfaces::msg::Distance(_init);
}

void Distance_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_robot_interfaces::msg::Distance *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Distance_message_member_array[1] = {
  {
    ...
    offsetof(my_robot_interfaces::msg::Distance, distance),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Distance_message_members = {
  ...
  1,  // number of fields
  sizeof(my_robot_interfaces::msg::Distance),
...
{
  return &::my_robot_interfaces::msg::rosidl_typesupport_introspection_cpp::Distance_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_robot_interfaces, msg, Distance)() {
  return &::my_robot_interfaces::msg::rosidl_typesupport_introspection_cpp::Distance_message_type_support_handle;
}
